    ...
    <div class="data"
      ...
      <div class="show-data" style="max-width: 45vw;padding: 15px 2px;">
        <ul style="display: flex;flex-wrap: wrap;justify-content: space-between;font-size: 10px">
          <li style="padding:10px 10px;font-size: 14px;color: rgb(140,140,140)">签到：<span>{{ pointD?pointD.type1:0 }}</span></li>
          <li style="padding:10px 10px;font-size: 14px;color: rgb(140,140,140)">评论：<span>{{ pointD?pointD.type2:0 }}</span></li>
          <li style="padding:10px 10px;font-size: 14px;color: rgb(140,140,140)">心得：<span>{{ pointD?pointD.type3:0 }}</span></li>
          <li style="padding:10px 10px;font-size: 14px;color: rgb(140,140,140)">活动：<span>{{ pointD?pointD.type:0 }}</span></li>
          <li style="padding:10px 10px;font-size: 14px;color: rgb(140,140,140)">收藏：<span>{{ pointD?pointD.type6:0 }}</span></li>
        </ul>
      </div>
    </div>
