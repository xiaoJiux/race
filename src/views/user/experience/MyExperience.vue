<template>
  <div id="MyExperience">
    <Header :title="'心得体会'"></Header>
    <div class="article" style="margin-top: 15px">
      <div v-for="item in articleList" :key="item.id" class="art-item" @click="$router.push({
        path: '/article',
        query: {
          id:item.id
        }
        ...
        <div class="card">
          ...
          <div class="box-bottom">
            ...
            <div class="card-bottom">
              <div class="left">
                <p><img src="../../../../public/navbar/ly.png" style="padding-right: 5px"> {{  }}</p>
...
export default {
  name: "MyExperience",
  components: {Header},  computed:{...mapState(['userData'])},
  data() {
    return {
      articleList:null
    }
