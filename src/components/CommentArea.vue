<template>
  <div id="Commentarea">
    ...
    <ul class="forum">
      <li v-for="item in 2" class="van-hairline--bottom father-item">
        ...
        <div class="box-content">
          <p class="content" style="font-size: 12px">
            这是文章简略内容这是文章简略内容这是文章简略内容这是文章简略内容这是文章简略内容这是文章简略内容这是文章简略内容</p>
          <div class="child-header">
            <p class="time" style="font-size:10px;color: #cccccc">09 / 17 <span
